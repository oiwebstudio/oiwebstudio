...
export const COMUNES = [
  ...
  [`Habitantes`, `Biztanle`],
  [`Desde, precio cerrado`, `Gutxieneko prezio itxia`],
  ...
  [`Publico y acompaño`, `Argitaratu eta lagundu`],
  ...
  "zonas/donostia-san-sebastian.html": {
    ...
    pares: [
      ...
      [`Donostia es el mercado más competido de Gipuzkoa: estudios grandes, agencias con equipo comercial y presupuestos que empiezan donde los míos acaban. Mi hueco no es competir por la cuenta de una multinacional, sino atender al comercio de Gros, Egia o Amara que necesita una web rápida y bien posicionada en su barrio, con precio cerrado.`,
       `Donostia da Gipuzkoako merkaturik lehiakorrena: estudio handiak, salmenta-taldea duten agentziak eta nire aurrekontuak amaitzen diren tokian hasten diren aurrekontuak. Nire tokia ez da multinazional baten kontua lortzeko lehiatzea, baizik eta Gros, Egia edo Amarako merkataritzari erantzutea: webgune azkar bat behar du, bere auzoan ondo kokatua eta prezio itxiarekin.`],
      ...
      [`Lo mismo que para uno de Tolosa: 199€ una Landing y 299€ una Web Negocio, pago único y 30 días de ajustes gratis. Ni los 26 km ni la comarca cambian la cifra, y la recibes cerrada por escrito.`,
       `Tolosako negozio batentzat adina: 199€ Landing batek eta 299€ Negozio Web batek, ordainketa bakarrean eta 30 egunez doikuntzak doan. Ez 26 km-ek ez eskualdeak ez dute zifra aldatzen, eta idatziz jasotzen duzu, itxita.`],
      ...
      [`Sí, pero con los pies en el suelo: 190.000 habitantes significan más negocios peleando por las mismas búsquedas, así que aquí el SEO local pesa más que en un pueblo. La web sale preparada para Donostia-San Sebastián y el resto lo hace tu ficha de Google Business, que trabajo contigo siguiendo <a href="../google-business-profile-guia.html">esta guía</a>.`,
       `Bai, baina oinak lurrean: 190.000 biztanlek esan nahi du negozio gehiago daudela bilaketa berberak lortzeko lehian; beraz, hemen tokiko SEOak herri batean baino pisu handiagoa du. Webgunea Donostiarako prestatuta ateratzen da, eta gainerakoa zure Google Business fitxak egiten du: zurekin lantzen dut, <a href="../google-business-profile-guia.html">gida honi</a> jarraituz.`],
      [`Sí, pero con los pies en el suelo: 190.000 habitantes significan más negocios peleando por las mismas búsquedas, así que aquí el SEO local pesa más que en un pueblo. La web sale preparada para Donostia-San Sebastián y el resto lo hace tu ficha de Google Business, que trabajo contigo siguiendo esta guía.`,
       `Bai, baina oinak lurrean: 190.000 biztanlek esan nahi du negozio gehiago daudela bilaketa berberak lortzeko lehian; beraz, hemen tokiko SEOak herri batean baino pisu handiagoa du. Webgunea Donostiarako prestatuta ateratzen da, eta gainerakoa zure Google Business fitxak egiten du: zurekin lantzen dut, gida honi jarraituz.`],
  ...
  "zonas/irun.html": {
    ...
    pares: [
      ...
      [`Puedo montar la web en castellano, euskera y francés — mismo diseño, tres públicos.`,
       `Webgunea gaztelaniaz, euskaraz eta frantsesez egin dezaket — diseinu bera, hiru publiko.`],
  ...
  "zonas/zarautz.html": {
    ...
    pares: [
      ...
      [`Para negocios de temporada, las reservas automáticas son lo que más se nota: en agosto responden solas.`,
       `Denboraldiko negozioetan, erreserba automatikoak dira gehien nabaritzen direnak: abuztuan beren kabuz erantzuten dute.`],
      ...
      [`Sí, pero con los pies en el suelo: 23.000 habitantes significan más negocios peleando por las mismas búsquedas, así que aquí el SEO local pesa más que en un pueblo. La web sale preparada para Zarautz y el resto lo hace tu ficha de Google Business, que trabajo contigo siguiendo <a href="../google-business-profile-guia.html">esta guía</a>.`,
       `Bai, baina oinak lurrean: 23.000 biztanlek esan nahi du negozio gehiago daudela bilaketa berberak lortzeko lehian; beraz, hemen tokiko SEOak herri txiki batean baino pisu handiagoa du. Webgunea Zarautzerako prestatuta ateratzen da, eta gainerakoa zure Google Business fitxak egiten du: zurekin lantzen dut, <a href="../google-business-profile-guia.html">gida honi</a> jarraituz.`],
      [`Sí, pero con los pies en el suelo: 23.000 habitantes significan más negocios peleando por las mismas búsquedas, así que aquí el SEO local pesa más que en un pueblo. La web sale preparada para Zarautz y el resto lo hace tu ficha de Google Business, que trabajo contigo siguiendo esta guía.`,
       `Bai, baina oinak lurrean: 23.000 biztanlek esan nahi du negozio gehiago daudela bilaketa berberak lortzeko lehian; beraz, hemen tokiko SEOak herri txiki batean baino pisu handiagoa du. Webgunea Zarautzerako prestatuta ateratzen da, eta gainerakoa zure Google Business fitxak egiten du: zurekin lantzen dut, gida honi jarraituz.`],
